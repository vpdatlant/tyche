...
$isSidebarLeft = isset($arParams['SIDEBAR_SECTION_POSITION']) && $arParams['SIDEBAR_SECTION_POSITION'] === 'left';
		...
		$elementId = $APPLICATION->IncludeComponent('bitrix:catalog.element', 'store_v3', $componentElementParams,
			$component
		);
		...
		if ($elementId > 0)
		{
			...
			{
				//region catalog.recommended.products
...
//				if (!isset($arParams['DETAIL_SHOW_POPULAR']) || $arParams['DETAIL_SHOW_POPULAR'] != 'N')
				...
				{
					?>
					<div class="catalog-element-addinational-blocks">
						<div class="catalog-element-addinational-block-header" data-entity="header" data-showed="false"><?=GetMessage('CATALOG_POPULAR_IN_SECTION')?></div>
				...
				//region catalog.products.viewed
				if (
